...
<Script id=" IO8rWGOrRB">{`(function(html){html.className = html.className.replace(/\bno-js\b/,'js')})(document.documentElement);`}</Script>
...
<meta name="msapplication-TileImage" content="https://www.midcitysmiles.com/blog/wp-content/uploads/2022/06/cropped-icon-270x270.png" />
	<Script type="application/ld+json" id=" zqaWOeTwLL">{`
{
