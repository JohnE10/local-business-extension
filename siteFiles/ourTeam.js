...
<li id="menu-item-144" className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-115 current_page_item menu-item-144"><a id="" className="" href="/ourTeam">Our Team</a></li>
...
<article id="post-115" className="post-115 page type-page status-publish hentry">
	<header className="entry-header">
		<h1 className="entry-title">OUR TEAM</h1>			</header>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image src="https://www.midcitysmiles.com/blog/wp-content/uploads/2022/05/perla-1.jpg" alt="/" width="252" height="349" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image src="https://www.midcitysmiles.com/blog/wp-content/uploads/2022/05/del.jpg" alt="/" width="252" height="349" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image src="https://www.midcitysmiles.com/blog/wp-content/uploads/2022/05/frye.jpg" alt="/" width="252" height="349" /></figure></div>
...
<li className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-115 current_page_item menu-item-144"><a href="https://www.midcitysmiles.com/blog/our-team/" aria-current="page">OUR TEAM</a></li>
