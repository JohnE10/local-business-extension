...
import Svg6 from '../../components/Svg6';
import Svg7 from '../../components/Svg7';
import Svg8 from '../../components/Svg8';
import Svg9 from '../../components/Svg9';
import Svg10 from '../../components/Svg10';
...
<div id="page" className="site">
	<Link className="dcsLink" href="#content">Skip to content</Link>
...
<figure className="aligncenter size-full"><Image decoding="async" width="250" height="350" src="/wp-content/uploads/2022/05/Anderson.jpg" alt="" className="wp-image-123" sizes="(max-width: 250px) 100vw, 250px" priority="false" /></figure></div>
...
<ul className="dcsUl"><li>Benjamin Franklin Senior High School,&nbsp;New Orleans</li><li>Louisiana State University,&nbsp;Baton Rouge</li><li>Louisiana State University School of Dentistry, New Orleans</li></ul>
...
<ul className="dcsUl"><li>American Dental Association</li><li>Louisiana Dental Association</li><li>New Orleans Dental Association&nbsp;</li><li>Academy of Sports Dentistry&nbsp;</li><li>American Academy of Clear Aligners</li><li>International Association of Dental Traumatology</li><li>Hispanic Dental Association</li><li>Academy of General Dentistry</li><li>United States Dental Institute&nbsp;</li><li>Psi Omega Dental Fraternity</li><li>Krewe of Endymion</li></ul>
...
<ul className="dcsUl"><li>New Orleans Pelicans, Team Dentist</li><li>University of New Orleans Athletics</li></ul>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="252" height="349" src="/wp-content/uploads/2022/05/perla-1.jpg" alt="" className="wp-image-129" sizes="(max-width: 252px) 100vw, 252px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="252" height="349" src="/wp-content/uploads/2022/05/del.jpg" alt="" className="wp-image-137" sizes="(max-width: 252px) 100vw, 252px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="252" height="349" src="/wp-content/uploads/2022/05/frye.jpg" alt="" className="wp-image-138" sizes="(max-width: 252px) 100vw, 252px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="250" height="350" src="/wp-content/uploads/2022/05/image-2.png" alt="" className="wp-image-126" sizes="(max-width: 250px) 100vw, 250px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter"><Image decoding="async" src="/images/shan.jpg" alt="Shannon" width="150" height="150" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="252" height="349" src="/wp-content/uploads/2022/05/gab.jpg" alt="" className="wp-image-130" sizes="(max-width: 252px) 100vw, 252px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="250" height="350" src="/wp-content/uploads/2022/06/haar-1.jpg" alt="" className="wp-image-298" sizes="(max-width: 250px) 100vw, 250px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="252" height="349" src="/wp-content/uploads/2022/05/cea.jpg" alt="" className="wp-image-131" sizes="(max-width: 252px) 100vw, 252px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter"><Image decoding="async" src="/images/Xo%20-%20Copy.jpg" alt="" width="150" height="150" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="252" height="349" src="/wp-content/uploads/2022/05/mary.jpg" alt="" className="wp-image-132" sizes="(max-width: 252px) 100vw, 252px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="250" height="350" src="/wp-content/uploads/2022/06/am.jpg" alt="" className="wp-image-291" sizes="(max-width: 250px) 100vw, 250px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="250" height="350" src="/wp-content/uploads/2022/05/image-3.png" alt="" className="wp-image-128" sizes="(max-width: 250px) 100vw, 250px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="250" height="350" src="/wp-content/uploads/2022/06/rosi.jpg" alt="" className="wp-image-295" sizes="(max-width: 250px) 100vw, 250px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="252" height="349" src="/wp-content/uploads/2022/05/js.jpg" alt="" className="wp-image-134" sizes="(max-width: 252px) 100vw, 252px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter"><Image decoding="async" src="/images/houria.jpg" alt="Houria" width="150" height="150" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter size-full"><Image decoding="async" width="252" height="349" src="/wp-content/uploads/2022/05/mona.jpg" alt="" className="wp-image-135" sizes="(max-width: 252px) 100vw, 252px" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter"><Image decoding="async" src="/images/kim.jpg" alt="Kim" width="150" height="150" priority="false" /></figure></div>
...
<div className="wp-block-image">
<figure className="aligncenter"><Image decoding="async" src="/images/kris%20-%20Copy.jpg" alt="" width="150" height="150" priority="false" /></figure></div>
